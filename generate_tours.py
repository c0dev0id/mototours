...
TOURS = [
    ...
    # ------------------------------------------------------------------
    {
        ...
        "waypoints": [
            ...
            ("Edenkoben", 49.283267, 8.119929, "Villa Ludwigsh\u00f6he", False),
            ...
            ("Ramberg", 49.244466, 7.973873, "Into the forest", False),
    ...
    },
    {
        ...
        "waypoints": [
            ...
            ("Elmstein", 49.359567, 7.939514, "Valley village", False),
            ...
            ("Weidenthal", 49.383721, 7.921809, "Forest village", False),
            ("Neidenfels", 49.376833, 8.042369, "Back to the valley", False),
    ...
    },
    {
        ...
        "waypoints": [
            ...
            ("Schweighofen", 49.052343, 8.097300, "Border villages", False),
            ("Steinfeld", 49.067, 8.051, "Quiet border region", False),
            ("Klingenm\u00fcnster", 49.135104, 8.013845, "Wine village", False),
    ...
    # ------------------------------------------------------------------
    {
        ...
        "waypoints": [
            ...
            ("Neckarsteinach", 49.404621, 8.838092, "Four Castle Town", False),
            ("Hirschhorn", 49.448, 8.893, "Pearl of the Neckar", False),
            ("Eberbach", 49.467, 8.988, "Medieval town \u2013 midpoint", True),
            ("Zwingenberg am Neckar", 49.352622, 9.039285, "Castle on the cliff", False),
            ...
            ("Bad Rappenau", 49.242307, 8.993003, "Return west", False),
    ...
    },
    {
        ...
        "waypoints": [
            ...
            ("Lindenfels", 49.568435, 8.780766, "Pearl of the Odenwald \u2013 midpoint", True),
    ...
    },
    {
        ...
        "waypoints": [
            ...
            ("Lindenfels", 49.568435, 8.780766, "Pearl of the Odenwald", False),
    ...
    },
    {
        ...
        "waypoints": [
            ...
            ("Str\u00fcmpfelbrunn", 49.499487, 9.039945, "Into deep forest", False),
            ("Katzenbuckel (626 m)", 49.481872, 9.004841, "Highest Odenwald peak", False),
    ...
    # ------------------------------------------------------------------
    {
        ...
        "waypoints": [
            ...
            ("Geroldsau", 48.721556, 8.241260, "Waterfall", False),
            ("B\u00fchlerh\u00f6he", 48.683338, 8.222543, "Join B500", False),
            ("Sand", 48.654527, 8.225886, "B500 junction", False),
            ...
            ("Kniebis", 48.483159, 8.287663, "Pass village", False),
    ...
    },
    {
        ...
        "waypoints": [
            ...
            ("Forbach", 48.684974, 8.348239, "Wooden bridge \u2013 midpoint", True),
    ...
    },
    {
        ...
        "waypoints": [
            ...
            ("Vogtsbauernhof, Gutach", 48.255812, 8.178635, "Open-air museum \u2013 midpoint", True),
    ...
    },
    {
        ...
        "waypoints": [
            ...
            ("Kloster Allerheiligen", 48.537973, 8.130656, "Ruined monastery \u2013 midpoint", True),
            ("Oppenau", 48.474, 8.161, "Renchtal", False),
            ("Bad Peterstal-Griesbach", 48.427, 8.202, "Spa village", False),
            ("Kniebis", 48.483159, 8.287663, "Pass", False),
            ("Ruhestein", 48.561, 8.221, "Join B500", False),
            ("Sand", 48.654527, 8.225886, "B500 north", False),
            ("Baden-Baden", 48.761, 8.241, "Spa city", False),
            ("Hockenheim", 49.322, 8.548, "End (via A5)", False),
        ],
        "overview": (
    ...
    },
    {
        ...
        "waypoints": [
            ...
            ("Enzkl\u00f6sterle", 48.664590, 8.468210, "Remote forest village", False),
    ...
    },
    {
        ...
        "waypoints": [
            ...
            ("Furtwangen", 48.054612, 8.208417, "Cuckoo clock museum", False),
    ...
    # ------------------------------------------------------------------
    {
        ...
        "waypoints": [
            ...
            ("W\u00f6rth-sur-Sauer", 48.937401, 7.737265, "Through the forest", False),
            ("Lauterbourg", 48.974458, 8.176915, "Back to Germany", False),
    ...
    },
    {
        ...
        "waypoints": [
            ...
            ("Col de Saverne", 48.735383, 7.303055, "Historic mountain pass", False),
    ...
    # ------------------------------------------------------------------
    {
        ...
        "waypoints": [
            ("Hockenheim", 49.322, 8.548, "Start/End", False),
            ("Sinsheim", 49.253, 8.879, "Head east", False),
            ("Bad Rappenau", 49.242307, 8.993003, "Saline tower", False),
            ("Bad Wimpfen", 49.231593, 9.165404, "Imperial palace \u2013 midpoint", True),
    ...
    },
    {
        ...
        "waypoints": [
            ("Hockenheim", 49.322, 8.548, "Start/End", False),
            ("Sinsheim", 49.253, 8.879, "Head east", False),
            ("Bad Rappenau", 49.242307, 8.993003, "Saline", False),
            ...
            ("Kloster Sch\u00f6ntal", 49.328184, 9.499211, "Baroque abbey", False),
    ...
    },
    {
        ...
        "waypoints": [
            ...
            ("Sulzbach an der Murr", 48.879172, 9.473148, "Forest edge", False),
    ...
    },
    {
        ...
        "waypoints": [
            ...
            ("Waldenburg", 49.189419, 9.632702, "Balcony of Hohenlohe \u2013 midpoint", True),
    ...
    },
    {
        ...
        "waypoints": [
            ...
            ("Zuzenhausen", 49.349728, 8.824247, "Rolling hills", False),
    ...
    # ------------------------------------------------------------------
    {
        ...
        "waypoints": [
            ...
            ("Enkenbach-Alsenborn", 49.486685, 7.906614, "Northern Pf\u00e4lzerwald", False),
            ("Otterberg", 49.504, 7.770, "Cistercian abbey", False),
            ("Kaiserslautern", 49.445, 7.769, "Brief pass", False),
            ("Johanniskreuz", 49.348, 7.850, "Forest crossroads", False),
            ("Elmstein", 49.359567, 7.939514, "Elmstein Valley", False),
            ...
            ("Edenkoben", 49.283267, 8.119929, "Weinstra\u00dfe", False),
            ("Speyer", 49.317, 8.431, "Cross Rhine", False),
            ("Hockenheim", 49.322, 8.548, "End", False),
        ],
        "overview": (
